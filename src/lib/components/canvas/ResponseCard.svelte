<script lang="ts">
	...
	import { X, Loader2, AlertCircle, ArrowUpRight, Heart, Clock, Coins } from '@lucide/svelte';
	...
	let { node, onRemove, onDragStart, onGetResponse, onToggleLike, canGetResponse = false }: Props = $props();
...
<Card.Root
	class="w-[400px] shadow-lg select-none"
